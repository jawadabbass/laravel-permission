...
@section('content')
    ...
    <!--begin: Datatable-->
    <form name="store_permissionGroup" id="store_permissionGroup" method="POST" action="{{ route(config('jawad_permission_uuid.route_name_prefix').'permissionGroup.update', [$permissionGroup->id]) }}">
